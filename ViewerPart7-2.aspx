<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewerPart7-2.aspx.cs" Inherits="ViewerPart7_2" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="view" runat="server" AutoGenerateColumns="false" CssClass="grid">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="original_content_id" Text="Select Comment to Delete!" runat="server" CommandArgument='<%# Eval("original_content_id")+";"+Eval("date")%>' OnClick="deletecomment" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
