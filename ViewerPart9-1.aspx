<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewerPart9-1.aspx.cs" Inherits="ViewerPart9_1" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="view" runat="server" AutoGenerateColumns="false" CssClass="grid">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="id" Text="Select Ad to Edit!" runat="server" CommandArgument='<%# Eval("id")%>' OnClick="editad" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
