<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewerPart6.aspx.cs" Inherits="ViewerPart6" %>
...
<body>
    ...
    <form id="Write_Comment" runat="server">
        ...
        <asp:GridView ID="view" runat="server" AutoGenerateColumns="false" CssClass="grid">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="ID" Text="Select Original Content to Comment On!" runat="server" CommandArgument='<%# Eval("ID")%>' OnClick="writecomment" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
